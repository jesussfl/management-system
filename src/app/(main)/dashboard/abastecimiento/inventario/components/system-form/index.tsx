...
import { Sistema, Subsistema } from '@prisma/client'
...
type FormValues = Sistema

export default function SystemForm({ defaultValues }: Props) {
  ...
  const onSubmit: SubmitHandler<FormValues> = async (values) => {
    startTransition(() => {
        ...
        createSystem(values).then((data) => {
          ...
          if (data?.success) {
            toast({
              ...
              description: 'El sistema se ha creado correctamente',
              variant: 'success',
            })
      ...
      updateSystem(defaultValues.id, dirtyValues).then((data) => {
        if (data?.success) {
          toast({
