...
export const createReturn = async (data: FormValues) => {
  ...
  await registerAuditAction(
    'CREAR',
    `Se creó una devolución en armamento con el siguiente motivo: ${motivo}. El ID de la devolución es: ${
      newReturn.id
    }, ${
      data.motivo_fecha
...
export const updateReturn = async (id: number, data: FormValues) => {
  ...
  await registerAuditAction(
    'ACTUALIZAR',
    `Se actualizo una devolución en armamento con el siguiente motivo: ${motivo}. El ID de la devolución es: ${
      updatedReturn.id
    } ${
      data.motivo_fecha
        ? `, la fecha de creación fue: ${format(
...
export const deleteReturn = async (id: number) => {
  ...
  await registerAuditAction(
    'ELIMINAR',
    `Se eliminó la devolución en armamento con el siguiente motivo: ${exist.motivo}. El ID de la devolución es: ${exist.id} `
  )
  revalidatePath('/dashboard/armamento/devoluciones')
...
export const recoverReturn = async (id: number) => {
  ...
  await registerAuditAction(
    'RECUPERAR',
    `Se recuperó la devolución en armamento con el siguiente motivo: ${exist.motivo}. El ID de la devolución es: ${exist.id} `
  )
  revalidatePath('/dashboard/armamento/devoluciones')
