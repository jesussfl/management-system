...
export const createDispatch = async (data: FormValues) => {
  ...
  await registerAuditAction(
    'CREAR',
    `Se realizó un despacho en armamento con el siguiente motivo: ${motivo}. El id del despacho es: ${
      dispatch.id
    }  ${
      data.motivo_fecha
...
export const deleteDispatch = async (id: number) => {
  ...
  await registerAuditAction(
    'ELIMINAR',
    `Se eliminó el despacho en armamento con el id: ${id}`
  )
  revalidatePath('/dashboard/armamento/despachos')
...
export const recoverDispatch = async (id: number) => {
  ...
  await registerAuditAction(
    'RECUPERAR',
    `Se recuperó el despacho en armamento con el id: ${id}`
  )
  revalidatePath('/dashboard/armamento/despachos')
...
export const deleteMultipleDispatches = async (ids: number[]) => {
  ...
  await registerAuditAction(
    'ELIMINAR',
    `Se han eliminado despachos en armamento con los siguientes ids: ${ids}`
  )
  revalidatePath('/dashboard/armamento/despachos')
