...
export const createOrder = async (data: PedidoFormValues) => {
  ...
  await registerAuditAction(
    'CREAR',
    `Se creó un nuevo pedido de armamento con el siguiente motivo: ${
      data.motivo
    }, el Id es: ${order.id} ${
      data.motivo_fecha
...
export const deleteOrder = async (id: number) => {
  ...
  await registerAuditAction(
    'ELIMINAR',
    `Se eliminó un pedido de armamento que tenía el motivo: ${exist?.motivo} con el id: ${id}`
  )
  revalidatePath('/dashboard/armamento/pedidos')
...
export const recoverOrder = async (id: number) => {
  ...
  await registerAuditAction(
    'RECUPERAR',
    `Se recuperó el pedido de armamento que tenía el motivo: ${exist?.motivo} con el id: ${id}`
  )
  revalidatePath('/dashboard/armamento/pedidos')
