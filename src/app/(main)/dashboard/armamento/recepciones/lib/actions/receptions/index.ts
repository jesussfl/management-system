...
export const createReception = async (data: FormValues) => {
  ...
  await registerAuditAction(
    'CREAR',
    `Se creó una recepción de armamento con motivo: ${data.motivo} y id ${
      recepcion.id
    } ${
      data.motivo_fecha
...
export const updateReception = async (id: number, data: FormValues) => {
  ...
  await registerAuditAction(
    'ACTUALIZAR',
    `Se actualizó una recepción de armamento con motivo: ${
      data.motivo
...
export const deleteReception = async (id: number) => {
  ...
  await registerAuditAction(
    'ELIMINAR',
    `Se eliminó la recepción de armamento con motivo: ${exist?.motivo} y el id ${id}`
  )
  revalidatePath('/dashboard/armamento/recepciones')
...
export const recoverReception = async (id: number) => {
  ...
  await registerAuditAction(
    'RECUPERAR',
    `Se recuperó la recepción de armamento con motivo: ${exist?.motivo} y el id ${id}`
  )
  revalidatePath('/dashboard/armamento/recepciones')
