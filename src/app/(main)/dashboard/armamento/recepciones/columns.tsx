    ...
    cell: ({ row }) => {
      return (
        <Link
          ...
          href={`/dashboard/armamento/recepciones/detalle/${row.original.id}`}
        >
          Ver detalles
        </Link>
      )
      ...
      return (
        <ProtectedTableActions
          ...
          deleteConfig={{
            ...
            onRecover: () => {
              return recoverReception(data.id, 'Armamento')
            },
            onConfirm: () => {
              return deleteReception(data.id, 'Armamento')
            },
          }}
        >
          <Link
            href={`/dashboard/armamento/recepciones/exportar/${String(
              data.id
            )}`}
          >
