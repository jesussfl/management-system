...
import { RecentSales } from './components/recent-users'
            ...
            <TabsContent value="overview" className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4">
                  <CardHeader>
                    <CardTitle>Resumen del abastecimiento</CardTitle>
                  </CardHeader>
                ...
                <Card className="col-span-3">
                  <CardHeader>
                    <CardTitle>Personal Registrado Recientemente</CardTitle>
                    <CardDescription>
                      Se han registrado 100 personas este mes.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <RecentSales />
